...
class Authenticate:
    ...
    def __init__(self, credentials: dict, cookie_name: str, key: str, cookie_expiry_days: int = 30,
        ...
        ----------
        credentials: dict
            The dictionary of usernames, names, passwords, and levels.
        cookie_name: str
    ...
    def _check_pw(self) -> bool:
        ...
        """
        # 这里改过，去掉了decode
        return bcrypt.checkpw(self.password,
            self.credentials['usernames'][self.username]['password'])
        # if self.password == self.credentials['usernames'][self.username]['password']:
        #     return True
        # else:
        #     return False
    ...
    def _check_credentials(self, inplace: bool=True) -> bool:
        ...
        if self.username in self.credentials['usernames']:
            try:
                if int(self.password) == self.credentials['usernames'][self.username]['password']:
                    if inplace:
    ...
    def _update_password(self, username: str, password: str):
        ...
        """
        self.credentials['usernames'][username]['password'] = password
    ...
    def _set_random_password(self, username: str) -> str:
        ...
        self.credentials['usernames'][username]['password'] = self.random_password
    ...
    def get_level(self, username: str) -> str :
        level = self.credentials['usernames'][username]['level']
        return level